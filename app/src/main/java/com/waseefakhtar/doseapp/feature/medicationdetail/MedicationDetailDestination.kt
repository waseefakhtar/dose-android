...
fun NavGraphBuilder.medicationDetailGraph(navController: NavController, bottomBarVisibility: MutableState<Boolean>, fabVisibility: MutableState<Boolean>, onBackClicked: () -> Unit, navigateToMedicationDetail: (Medication) -> Unit) {
    ...
    composable(
        ...
        MedicationDetailRoute(medication, onBackClicked, navigateToMedicationDetail)
    }
}
